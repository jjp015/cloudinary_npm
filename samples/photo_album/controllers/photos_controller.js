...
function create_through_server(req, res) {
    ...
    cloudinary.uploader.upload(imageFile, {width: 500, height: 500, crop: "limit",
        categorization: "google_tagging", auto_tagging: 0.7,    // Enable "Google Auto Tagging" Add-on in Cloudinary API
        tags: "sample, demo, test, photo, cloudinary"
    })
        .then(function (image) {
